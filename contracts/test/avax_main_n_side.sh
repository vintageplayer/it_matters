...
node orchestrator.mjs avaxfuji_main register_chain avaxfuji_side
echo "\nRegistering main contract to side contract..."
node orchestrator.mjs avaxfuji_side register_chain avaxfuji_main
...
node orchestrator.mjs avaxfuji_side submit_vaa avaxfuji_main latest

echo "\nVoting inFavor of proposal on main contract"
node orchestrator.mjs avaxfuji_main cast_vote 1 1
echo "\nVoting neutral on side contract"
node orchestrator.mjs avaxfuji_side cast_vote 1 1
echo "\nSleeping for 5 minutes for voting deadline to end..."
sleep 300
echo "\nTriggering End of voting period on main contract..."
node orchestrator.mjs avaxfuji_main end_voting 1
echo "\nSubmitting end of voting message to side contracts..."
node orchestrator.mjs avaxfuji_side submit_end_of_voting avaxfuji_main latest
echo "\nSubmitting vote tally message to main contract..."
node orchestrator.mjs avaxfuji_main submit_vaa avaxfuji_side latest
echo "\nExecuting Proposal on main contract..."
node orchestrator.mjs avaxfuji_main execute_proposal 1
